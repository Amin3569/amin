...
class AdminController extends Controller
{
    ...
    public function create_produk(Request $request)
    {
        ...
        if($validator->passes()){
            ...
            return redirect()->back()->withErrors($validator)->with("failed"," data insertion failed ! ");
        }
    }
    ...
    public function update_produk(Request $request)
    {
        ...
        if($validator->passes()){
            ...
            return redirect()->back()->with("success"," product data updated successfully ".$request->get("nama_produk").' !');
        }
        else{
            return redirect()->back()->withErrors($validator)->with("failed"," fail to update data ! ");
        }
    }
    ...
    public function update_profil(Request $request)
    {
        ...
        if($validator->passes())
        {
            if($request->get("password") == $request->get("password_confirmation"))
            {
                ...
                return redirect()->back()->with("failed","confirmation of data not the same !");
            }
        }
        else{
            return redirect()->back()->withErrors($validator)->with("failed"," failed to update data ! ");
