    ...
    <div class="container">
        ...
        <div class="row">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                            ...
                            <div class="form-group">
                                ...
                                <button type="submit" class="btn btn-primary mt-3 btn-md">SUBMIT</button>
                            @if(!empty($request->get('id')))
                                <a href="{{ route('admin.kategori') }}" class="btn btn-danger mt-3">DELETE</a>
                            @endif
                        </form>
                    </div>
                </div>
            ...
            <div class="col-sm-8">
                <div class="card card-rounded">
                    <div class="card-header bg-primary text-white">
                        <h5 class="card-title pt-2"> <i class="fas fa-database me-1"></i> CATAGORY DATA</h5>
                    </div>
                    <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{url("admin/kategori/delete/$r->id")}}" 
                                                    ...
                                                    onclick="javascript:return confirm(`do you want to delete the data ?`);" 
                                                    title="Delete">
