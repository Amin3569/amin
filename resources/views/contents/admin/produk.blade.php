                    ...
                    <div class="col-sm-4 ms-auto">
                        <form method="get" action="">
                            <div class="input-group mb-3">
                                <input type="text" value="{{$request->get('search')}}" name="search" id="search" class="form-control" placeholder="Search Products" aria-describedby="helpId">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{url("admin/produk/delete/$r->id")}}" 
                                        ...
                                        onclick="javascript:return confirm(`Do you want to delete ?`);" title="Delete">
