...
<html lang="en">
    <head>
        <title>{{ $title ?? 'AMIN STORE' }}</title>
        <!-- Required meta tags -->
        <!-- CSRF Token -->
        <meta name="csrf-token" content="{{ csrf_token() }}">
        <meta charset="utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
        <meta content="ONLINE SHOPPING SOLUTION" name="description">
        <meta content="{{ $title ?? 'AMIN STORE' }}" name="keywords">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <a href="https://t.me/acidamin" class="text-terhubung"><i class="fab fa-telegram"></i></a>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">
                            <i class="fas fa-search mr-2"></i> CART
                        </h5>
